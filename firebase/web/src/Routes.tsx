...
import { Router, Route, Private, Set, PrivateSet } from '@redwoodjs/router'
...
const Routes = () => {
  return (
    <Router useAuth={useAuth}>
      ...
      <PrivateSet wrap={ScaffoldLayout} unauthenticated="login" title="Posts" titleTo="posts" buttonLabel="New Post" buttonTo="newPost">
